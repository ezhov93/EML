...
#define F(string_literal) (reinterpret_cast<const __FlashEStringHelper *>(PSTR(string_literal)))
...
public:
	...
	EString & operator += (const EString &rhs)	{concat(rhs); return (*this);}
	EString & operator += (const char *cstr)		{concat(cstr); return (*this);}
	EString & operator += (char c)			{concat(c); return (*this);}
	EString & operator += (unsigned char num)		{concat(num); return (*this);}
	EString & operator += (int num)			{concat(num); return (*this);}
	EString & operator += (unsigned int num)		{concat(num); return (*this);}
	EString & operator += (long num)			{concat(num); return (*this);}
	EString & operator += (unsigned long num)	{concat(num); return (*this);}
	EString & operator += (float num)		{concat(num); return (*this);}
	EString & operator += (double num)		{concat(num); return (*this);}
	EString & operator += (const __FlashEStringHelper *str){concat(str); return (*this);}

	friend EStringSumHelper & operator + (const EStringSumHelper &lhs, const EString &rhs);
	friend EStringSumHelper & operator + (const EStringSumHelper &lhs, const char *cstr);
	friend EStringSumHelper & operator + (const EStringSumHelper &lhs, char c);
	friend EStringSumHelper & operator + (const EStringSumHelper &lhs, unsigned char num);
	friend EStringSumHelper & operator + (const EStringSumHelper &lhs, int num);
	friend EStringSumHelper & operator + (const EStringSumHelper &lhs, unsigned int num);
	friend EStringSumHelper & operator + (const EStringSumHelper &lhs, long num);
	friend EStringSumHelper & operator + (const EStringSumHelper &lhs, unsigned long num);
	...
	friend EStringSumHelper & operator + (const EStringSumHelper &lhs, const __FlashEStringHelper *rhs);

	// comparison (only works w/ EStrings and "strings")
	operator EStringIfHelperType() const { return buffer ? &EString::EStringIfHelper : 0; }
	...
	EString substring( unsigned int beginIndex ) const { return substring(beginIndex, len); };
